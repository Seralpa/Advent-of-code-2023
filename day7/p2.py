...
class Hand:
	...
	def type(self) -> HandType:
		match Counter(self.cards).most_common():
			...
			case [(_, 4), *_] if "J" in self.cards:
				return HandType.REPOKER
			case [(_, 4), *_]:
				return HandType.POKER
			case [(_, 3), (_, 2), *_] if "J" in self.cards:
				return HandType.REPOKER
			case [(_, 3), (_, 2), *_]:
				return HandType.FULL_HOUSE
			case [(_, 3), (_, 1), *_] if "J" in self.cards:
				return HandType.POKER
			case [(_, 3), (_, 1), *_]:
				return HandType.TRIO
			case [(_, 2), (_, 2), *_] if self.cards.count("J") == 2:
				return HandType.POKER
			case [(_, 2), (_, 2), *_] if "J" in self.cards:
				return HandType.FULL_HOUSE
			case [(_, 2), (_, 2), *_]:
				return HandType.TWO_PAIR
			case [(_, 2), (_, 1), *_] if "J" in self.cards:
				return HandType.TRIO
			case [(_, 2), (_, 1), *_]:
				return HandType.PAIR
			case _ if "J" in self.cards:
				return HandType.PAIR
			case _:
